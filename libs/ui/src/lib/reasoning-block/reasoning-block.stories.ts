...
export const NightMode: Story = {
  ...
  decorators: [
    ...
    (storyFn) => {
      ...
      return {
        ...story,
        template: `<div class="night-mode bg-jungle-night-card p-4">${story.template ?? '<app-reasoning-block [reasoning]="reasoning" [streaming]="streaming" [durationMs]="durationMs" [autoCollapsed]="autoCollapsed"></app-reasoning-block>'}</div>`,
      };
    },
  ],
};

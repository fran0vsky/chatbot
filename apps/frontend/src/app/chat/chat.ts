...
import { HeaderBar, HistoryPanel, InputComposer, MascotPanel, MessageBubble, ModelSelector, ReasoningBlock, ToolCallBubble } from '@chatbot/ui';
...
@Component({
  standalone: true,
  selector: 'app-chat',
  imports: [HeaderBar, HistoryPanel, InputComposer, MascotPanel, MessageBubble, ModelSelector, ReasoningBlock, ToolCallBubble],
